    ...
    <div className="min-h-[calc(100vh-120px)] flex">
      <aside className="bg-black text-white min-h-[100%] w-full drop-shadow-sm shadow-green-500  md:max-w-60 max-w-32 shadow-md">
        ...
        <div className="md:w-full w-[50%]">
          ...
          <Link to="/admin-panel/all-users" className={`px-2 py-1 text-center rounded-sm border border-green-600 ${getLinkClassName('/admin-panel/all-users')}`}>All Users</Link>
          <Link to="/admin-panel/all-products" className={`px-2 py-1 text-center rounded-md border border-green-600 ${getLinkClassName('/admin-panel/all-products')}`}>Products</Link>
          </nav>
        </div>
      </aside>
