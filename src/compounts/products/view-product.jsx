          ...
          <div className="grid md:grid-cols-2 lg:mt-0 md:mt-[30px] grid-cols-1 md:gap-4">
            <div className="relative">
              <div className="main-slider-container">
                <img
                  className="object-cover w-[80%] h-[500px] lg:h-[480px] md:h-[400px] transition-transform duration-300 ease-in-out transform hover:scale-110"
                  src={mainImage}
                  alt="Main product"
                />
              </div>
              <Slider
                {...thumbnailSettings}
                ref={thumbnailSlider}
                className="thumbnail-slider absolute mt-[30px]  w-[80%] lg:mt-[20px] md:mt-[0px] left-0 bg-gray-900 bg-opacity-50 p-2"
              >
